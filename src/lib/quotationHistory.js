...
function fixedRows(snapshot, calc) {
  ...
  if (items.cabinetEnabled) add(items.cabinet?.itemName || "Cabinet", items.cabinet?.brand || "", items.cabinet?.model || "", "Pcs", items.cabinetQty, unit.unitCabinet, totals.totalCabinet);
